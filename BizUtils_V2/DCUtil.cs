...
namespace DC
{
    public static class DCUtil
    {
        ...
        public static T JsonBytesToObj<T>(byte[] jsonBytes)
        {
            return JsonConvert.DeserializeObject<T>(Encoding.GetString(jsonBytes), jsonSettings);
        }

        public static byte[] ObjToJsonBytes(object obj)
        {
            return Encoding.GetBytes(JsonConvert.SerializeObject(obj, jsonSettings));
        }
